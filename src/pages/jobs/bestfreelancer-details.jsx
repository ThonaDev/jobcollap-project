...
function FreeLancerDetail() {
  return (
    <div className="bg-[#F5F5F5] min-h-screen p-4 flex justify-center">
...
<div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 w-full">
  ...
  {/* Name and Title */}
  <div className="w-full sm:w-auto mt-2 text-center sm:text-left">
    <h1 className="text-2xl font-semibold">Ben Thona</h1>
  ...
  <div className="mt-4 sm:mt-0 sm:ml-auto flex justify-center sm:justify-end w-full sm:w-auto">
    <button className="bg-[#1A5276] text-white border border-[#1A5276] px-5 py-2 rounded-[10px] hover:bg-white hover:text-[#1A5276] h-[45px] whitespace-nowrap text-sm sm:text-base md:text-base transition-colors duration-200">
      Send Mail
    </button>
  </div>
</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
              {/* Biography */}
              <div>
                <h2 className="font-semibold mb-2 text-left text-lg md:text-xl">
                  BIOGRAPHY
                </h2>
                <p className="text-sm sm:text-base md:text-base text-left leading-relaxed">
